...
В таблице ниже представлены замеры времени выполнения для 1 000 000 элементов `int32_t`. Эксперименты проводились с разным соотношением MPI-рангов и OpenMP-потоков для выявления наиболее эффективной конфигурации и анализа накладных расходов.
